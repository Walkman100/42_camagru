...
<div class='form'>
    ...
    <form method='POST' action='api/account.php' id='form1' onsubmit="return submitForm('form1');">
...
<div class='form'>
    ...
    <form method='POST' action='api/account.php' id='form2' onsubmit="return submitForm('form2');">
...
<div class='form'>
    ...
    <?php
        ...
        { ?>
            ...
            <form method='POST' action='api/account.php' id='form3' onsubmit="return submitForm('form3');">
        ...
        <?php }
    ?>
    <form method='POST' action='api/account.php' id='form4' onsubmit="return submitForm('form4');">
...
<div class='form'>
    ...
    <form method='POST' action='api/account.php' id='form5' onsubmit="return submitForm('form5');">
              <label>
...
<div class='form'>
    ...
    <form method='POST' action='api/account.php' id='form6' onsubmit="return submitForm('form6');">
